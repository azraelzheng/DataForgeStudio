...
### 新增
- 看板管理系统：支持创建、编辑、删除看板，网格布局拖拽配置
- 车间大屏模式：全屏展示、多看板轮播、定时数据刷新
- 看板组件：图表组件（ECharts）、数字卡片、数据表格、进度条、状态指示灯
- 新增权限：dashboard:view/create/edit/delete、display:view/config

### 变更
- 侧边栏菜单添加"看板管理"和"车间大屏"入口
